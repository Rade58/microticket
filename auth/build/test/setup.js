...
// DEFINISEM TU METODU
global.makeRequestAndTakeCookie = function () { return __awaiter(void 0, void 0, void 0, function () {
    var email, password, response, cookie;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                email = "stavros@stavy.com";
                password = "SuperCoolPerson66";
                return [4 /*yield*/, supertest_1.default(app_1.app)
                        .post("/api/users/signup")
                        .send({ email: email, password: password }) // NE TREBA TI EXPECTATION
