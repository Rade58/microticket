...
function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, possibleUser, newUser, userJwt;
        ...
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, user_model_1.User.findOne({ email: email })
                        ...
                        .exec()];
            case 1:
                possibleUser = _b.sent();
                if (possibleUser && possibleUser.email) {
                    throw new common_1.BadRequestError("Email already in use!");
                }
                return [4 /*yield*/, user_model_1.User.create({ email: email, password: password })];
            case 2:
                newUser = _b.sent();
                userJwt = jsonwebtoken_1.sign({ email: newUser.email, id: newUser._id }, process.env.JWT_KEY);
                req.session = {
                    jwt: userJwt,
                };
