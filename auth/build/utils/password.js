...
var scriptAsync = util_1.promisify(crypto_1.scrypt);
var Password = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, scriptAsync(password, salt, 64)];
                    case 1:
                        buf = (_a.sent());
    ...
    Password.compare = function (storedPassword, suppliedPassword) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, hashedPassword, salt, buf, hexedPass;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = storedPassword.split("."), hashedPassword = _a[0], salt = _a[1];
                        return [4 /*yield*/, scriptAsync(suppliedPassword, salt, 64)];
                    case 1:
                        buf = (_b.sent());
                        hexedPass = buf.toString("hex");
                        return [2 /*return*/, hashedPassword === hexedPass];
                }
            });
        });
    };
