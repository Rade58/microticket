...
PRVO CU TI RECI DA SAM JA [DNS RECORDS PODESAVAO VEC JEDNOM, I TO JE BILO OVDE](https://github.com/Rade58/apis_trying_out_and_practicing/blob/master/Node.js/7.%20FULL%20STACK/d%29%20SETUP%20SERVER-A/2.%20DOMAIN%20SETUP.md)

SAMO STO SAM JA TADA PODESIO DVA `A` RECORDA

DOK U TRENUTNOM WORKSHOP-U AUTOR WORKSHOPA ZELI DA ZADA JEDAN `A` RECORD I JEDAN `CNAME` RECORD

**KSNIJE SAM SAZNAO DA OVO I NIJE BAS DOBRO**

ZATO CU JA PODESITI DVA `A` RECORD-A

***

DAKLE, OVDE MOZEMO PODESAVATI COUPLE OF DIFFERENT SETTINGS

MOZE DODATI SOME NEW RECORDS TO CUSTOMIZE HOW DOMAIN NAME BEHAVES
...
**REKAO SAM DA NECU PODESAVATI `CNAME`, ALI EVO KKO BI ISLO TO PODESAVANJE**
...
PODESICU JOS JEDAN `A` RECORD

1. ZA *'HOSTNAME'* UNOSIS `www` 
