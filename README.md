...
**CILJE JE DA MI NAPRAVIMO SVE POTREBNE KLASE KOJE EXTEND-UJU ABSTRACT Listener; I DA, TO STAVIMO U NAS [`@ramicktick/common` LIBRARY](https://www.npmjs.com/package/@ramicktick/common)**
