...
MOGAO SI DAKLE OVO GORE DA ISPITAS PAST-UJUCI URL (`microticket.com/api/users/currentuser`) INTO BROWSER
...
**DALJE SI MOGAO VIDETI ONAJ CONSOLE LOG IZ NODJS EXPRESS SERVERA VEZANOG ZA TRENUTNO MOJ JEDINI MICROSERVICE**

BITNO JE RECI DA `TAJ LOGGING INFORMATION DOLAZI IZ POD-A, KOJI RUNN-UJE NA REMOTE VIRTUAL MACHINE-U NA GOOGLE CLOUD-U`

NISTA NE RUNN-UJE LOCALY ANYMORE

THAT IS PRETTY AWESOME

**KADA BUDEM DODAVAO MORE DPLOYMENTS, MORE PODS TO OUR CLUSTER, TTO NECE USPORAVATI MOJ LOCAL MACHINE, JER CE ZA SAV HEAVY LIFTING BITI ODGOVORNA REMOTE MACHINE GOOGLE CLOUD-A**

## NAIME, TVOJ CLUSTER RUNN-UJE NA GOOGLE CLOUD-U, I DOK ON RUNN-UJE TO TI TROSI ONAJ FREE CREDIT

ZATO, KADA MI ZAVRSIOMO OVAJ CEO PROJEKAT, JA CU VEROVATNO MORATI DA DELET-UJEM CLUSTER

TO JE ZATO DA NE BI PREKORACIO FREE TIER I POCEO DA PLACAM; IN THEORY TO BI SE DESILO, MEDJUTIM JA NISA JOS KLIKNUO NA UPGRADE PLANA, KAKO BI OMOGUCIO DA KADA SE ZAVRSI FREE TIER DA SE DALJE PLACE AS YOU GO, AS YOU SPEND RESOURCES

ZA SADA VIDIM DA BUKVALNO MOJ CLUSTER TROSI OKO 1 DOLAR DNEVNO (NE CEO ALI AROUND THAT)

DAKLE JA CU SIGURNO DELET-OVATI CLUSTER KADA ZAVRSIM SA DEVELOPMENTOM I NECU KLIKNUTI NA UPGRADE
