...
OVO CU SADA POKUSATI DA PODESIM NA NACIN DA CU KREIRATI NOVE DOKERFILE-OVE ZA PRODUCTION, A TO ZNACI DA CU KORIGOVATI I WORKFLOW FILE-OVE NA GITHUB-U, KAKO BI TAMO DEFINISAO BUILDING DRUGOG IMAGE-A, 
ALI UZ POMOC NOVOG DOCKER FILE-A

***

digresija:

NE BRINI SE NISTA, O TOME KOJI SE DOCKER FILE-OVI KORISTI ZA DEVELOPMENT; **JER NJIH SI EKSPLICITNO PODESIO U `skaffold` KONFIGURACIJI: `skaffold.yaml`**

***

# PRVO CEMO, ZA JEDAN OD NASIH MICROSERVICE, NAPRAVITI BUILD SCRIPT (ZA TRANSPILING TYPESCRIPT-A U JAVASCRIPT), I STARTUP SCRIPT (U KOJIMA CU DEFINISATI RUNNING MICROSERVICE APLIKACIJE AGAINST `node` EXECUTABLE)
...
## U SLEDECOJ LEKCIJI, NAPRAVICU JOS NEKE FIX-OVE

KOJI SE MOGU TICATI TOGA DA LI NAS PRODUCTION NEXTJS APP RUN-UJE U PRODUCTION ILI DEVELOPMENT MODE-U

KONKRETNO NAJVAZNIJA STVAR KOJU TREBAM POPRAVITI JETE ONAJ `baseUrl` KOJI SE KORISTI ZA SLANJE REQUEST-OVA IZ JEDNOG POD- U DRUGI; **TAJ URL JE POSEBAN A ZBOG GRESKE NA DIGITAL OCEAN-U, KORISTIM <http://www.microticket.xyz/> KAO TAJ URL**

I POKUSACU DA RESIM JOS NEKE PROBLEME
