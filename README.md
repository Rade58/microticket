...
A KORISTIO SAM GA U SIGNIN SIGNUP SIGNOUT PAGE-OVIMA ZA PROGRAMATIC NAVIGATION KAD SE KORISNIK USPENO SIGNUJE IN ILI SIGNUJE UP, A KAD ASE SIGN-UJE OUT REDIRECTING JE BIO NA SIGNUP PAGE

POGLEDAJ KAKO SAM NAPRAVIO HOOK, MOZDA JE MALO MESSY ALI NEMA VEZE `client/hooks/useRequest.ts`

#### MISLIO SAM DA NESTO TREBAM DA MENJAM ALI NA KRAJU JE ISPALO DA NISTA NE TREBAM DA MENJAM
