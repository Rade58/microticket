...
CIST ODA NAPOMNEM DA JE `getServerSideProps` FUNKCIJA NIKAD NECE IZVRSITI IN BROWSER, TO JE SERVER SIDE CODE

TO TI GOVORIM JER JE U RANIJIM VERZIJAMA NEXT-A POSTOJALA *getInitialProps* KOJA SE IZVRSAVALA INSIDE BROWSER KADA SE NAVIGATE-UJE FROM ONE ROUTE OF YOUR NEXT APP TO ONE WITH, MENTIONED HOOK

***

## JA CU, OVDE ZA KRAJ OVOG BRANCH-A, SAMO DODATI HELPER, KOJI ODREDJUJE DA LI JE U PITANJU SERVER ILI BROWSER; ODNOSNO FUNKCIJU KOJA IZBACUJE BOOLEAN true AKO JE U PITANJU SERVER SIDE, I OBRNUTO AKO NIJE 
