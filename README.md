...
# MI CEMO DAKLE STVARI URADITI DRUGACIJE ,SVE ZBOG TOGA JER SMO PRE SVEG OVOG DEFINISANJA VEC IMALI REPO, KOJI SMO KORISTILI; ODNONO NISMO BILI U main BRANCH-U NA POCETKU
...
# VAZNO JE UZETI ONE PROMENE KOJE SMO NAPRAVILI KADA SMO EDITOVALI yml FILE U SAMOM GITHUB UI-U
...
SADA SMO SVE OBAVILI STO SMO TREBALI

ODNOSNO USPESNO SMO PUSH-OVALI SVE PROMENE

## U SLEDECOM BRANCH-U CEMO NAS WORKFLOW PUT-OVATI TO TEST

CHANGE-OVACEMO NESTO I SIMULATE-OVACEMO REAL WORKFLOW KROZ KOJI CEMO MORATI DA PROLAZIMO
