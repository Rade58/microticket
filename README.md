...
GORE UMESTO USLOVNE IZJAVE U MAP-U MOGAO SI PRE map CHAIN-OVATI filter METHOD OVAKO `.filter(item => item)` (ALI NEMA VEZE, FUNKCIONISE I ONAO KAKO SAM JA DEFINISAO GORE)
