...
# TI CES MORATI TAJ SIGNING KEY DA SHARE-UJES SA SVIM TVOJ MICROSERVICE-OVIMA, KAKO BI SE PROVERIO VALIDITI JWT-A

I TU IMA JEDAN DOWNSIDE

AKO NEKI MALICIOUS HACKER DOBIJE ACCESS TO SAMO JEDNOG OD TVOJIH MICROSERVICE-A ON MOZE DA POCNE DA MANUFACTURE-UJE THEITR OWN TOKENS KOJI CE BITI VALID

**JA SAM GA TRENUTNO U MOM CODEBASE-U HARDCODE-OVAO STO JE LOSE**

JA SAM RANIJE KORISTIO ENVIROMENT VARIABLE ZA STORING SECRETS, AL ISADA SMO MI U KUBERNETES LAND-U 

A U SLEDECEM BRANCH-U CU POKAZATI SECUTRE WAY OF STORING SECRETS

ALI JA MORAM OTKRITI KAKO DA TO URADIM U KUBERNETES INFRASTRUCTURE-U
