...
MOZES ZA KRAJ OPET DA PROVERIS TVOJ PAKET NA NPM-U DA LI JE DOBIO NOVU VERZIJU (NARAVNO TO CE TI BITI POKAZNO I U TERMINALU KAO OUTPUT SVEGA STO SE IZVRSILO UNDER: npm run pub)
