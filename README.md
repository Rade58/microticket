...
TO MORAMO URADITI TAKO STO CEMO MODIFIKOVATI POD CONFIG FILE-OVE; TU MISLIM NA DEPLOYMENT CONFIG FILE-OVE

ZA SADA JA IMAM SAMO JEDAN, A TO JE `infra/k8s/auth-depl.yaml`

JA MORAM RECI KUBERNETESU DA KAD GOD KREIRA TAJ POD, ZELIM ODA NDAJE SECRET OBJECT, I IZ NJEGA UZME ONAJ `JWT_KEY` I NJEGOV VALUE I ASSIGN-UJE GA KAO ENVIROMENT VARIABLE KOJE SE APEAR-UJU U CONTAINERU

DA IMAS VISE VARIABLI TI BIH PODESAVA DA ASSIGN-UJE SET ENVIROMNT VARIABLIS (ALI NEMAS, IMAS SMO JEDNU)
...
SADA MOZEMO DA ODEMO U CODEBASE NASEG auth MICROSEVICE-A, GDE MOZEMO DA REFERENCIRAMO GORE PODESENU ENV VARIABLU

ALI TO PLANIRAM DA URADIM U SLEDECEM BRANCH-U
