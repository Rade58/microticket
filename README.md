...
## AKO TI SKAFFOLD NIJE RADIO KAKO TREBA, ODNOSNO THROW-OVAO ERRORS TOKOM SVIH PROMENA KOJE SI RADIO, SAMO RESTARTUJ SKAFFOLD

***
***

# SECAS SE DA TI IMAS I ONU MONGODB INSTANCU, KJA JE TIED TO `auth` MICROSERVICE

MOZES DA I TAMO PODESIS ISTO STO SI PODESAVAO TOKOM OVOG BRANCH-A; DA USTVARI U CONFIG-U `infra/k8s/auth-depl.yaml` SPECIFICIRAS ENV VARIABLE U KOJEM CE BITI URI ZA MONGO INSTANCU TIED TO MENTIONED MICROSERVICE

NRAVNO, ONDA CES PODESITI U `auth/src/index.ts`, UMESTO KORISCENJA HARDCODED URI, ONAJ URI INSIDE ENV VARIABLE

SAM POGLEDAJ U POMENUTIM FILE-OVIMA KAKO SAM TO SVE PODESIO
