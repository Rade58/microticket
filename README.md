...
## ZASTO JE THROWN `Error: connect ECONNREFUSED` ERROR
...
MEDJUTIM **KADA SA Nextjs SERVERA (`getServerSideProps`), KOJI JE SAM U SVOM POD-U, SALJES REQUEST PREMA `/api/users/current-user` TO CE PRAVITI REQUEST, KOJI JE KAKO SI ZADAO RELATIVE PATH ONLY; TAJ REQUEST CE SE DAKLE DOCI DO NETWORK LAYERA ONE VIRTUAL MIACHINE-E GDE RUNN-UJE TVOJ NEXT-JS; I BICE DIRECTED PREM TOJ ISTOJ MACHINE-I**
