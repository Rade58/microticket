...
# AUTOR WORKSHOPA JE DRUGACIJE RESTARTOVAO POD U KOJEM MU JE NEXTJS APP

JA TO NECU URADITI, JER SE MOJ IMAGE UREDNO REBUILD-OVAO U TOM POD-U

ALI EVO KAKO DA MANUALLY KILL-UJES POD

- `kubectl get pods`

```zsh
NAME                               READY   STATUS    RESTARTS   AGE
auth-depl-5d9dd95765-5vpvt         1/1     Running   0          12m
auth-mongo-depl-5c88f475bc-k4c4b   1/1     Running   0          12m
client-depl-8c8868c94-ktgr4        1/1     Running   0          12m
```

EVO GA POD ZA TVOJ NEXTJS MICROSERVICE, `client-depl-8c8868c94-ktgr4`

KILL-UJEM GA

- `kubectl delete pod client-depl-8c8868c94-ktgr4`

**NAKON KILL-A POD, CLUSTER BI TREBAO DA AUTOMATSKI NAPRAVI NOVI POD**

- ``

```zsh
NAME                               READY   STATUS    RESTARTS   AGE
auth-depl-5d9dd95765-5vpvt         1/1     Running   0          13m
auth-mongo-depl-5c88f475bc-k4c4b   1/1     Running   0          13m
client-depl-8c8868c94-xq4f2        1/1     Running   0          14s

```

**KAO STO VIDIS ODMAH JE NAPRAVLJEN NOVI POD**

OVO JE MOZDA BRZA OPCIJA OD MOJE, SA RESTARTINGO MSKAFFOLD-A
