...
IAKO JOS NISMO DEFINISALI APPLY-ING NASIH KUBERNETES CONFIG FILE-OVA NA NAS DIGITALOCEAN CLUSTER; SADA CEMO SE POZABAVITI ONIM POSLEDNJIM KORAKOM, KOJI SE DESAVA U DEPLOYMENTU SINGLE MICROSERVICE-A, A TO JE ACTUAL DEPLOYMENT MICROSERVICE-A, A TAJ KORAK CE KAKO CES VIDETI IMATI DOSTA POSLA
...
# MI JOS OVO NE MOZEMO TESTIRATI; JER NAS CLUSTER NE RUNN-UJE TRENUTNO ANYTHING RELATED TO THE auth-depl AT ALL

NISMO APPLY-OVALI NASE ORIGINAL KUBERNATES CONFIG FIILES NA NAS DIGITAL OCEAN CLUSTER

**MI CEMO MORATI DEFINISATI JOS JEDAN WORKFLOW, KOJI UZIMA SVE IZ `infra/k8s` DIREKTORIJUMA, I APPLY-UJE ALL THOSE CONFIG FILES TO OUR CLUSTER**

***

digresija: OPET TI NAPOMINJEM DA IMAS POGRESNE IMAGE SPECIFICIRAN U TIM FILE-OVIMA

ALI MISLIM DA CEMO TO RESITI U SLEDECEM BRANCH-U
