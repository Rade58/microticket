...
NA PRIMER IMAS `transction` MICROSERVICE, I ON PRIMA REQUEST OD USER-A, A U TOM REQUESTO JE DATA KOJA IMA NEKI USER ID, VISINU DEPOZITA KOJI KORISNIK PRAVI
...
EVENT CE OTICI DO NATS STREAMING SERVER-A, DO APPROPRIATE KANALA

A ONDA CE NEKI LISTENER MICROSERVICE, ODNOSNO NEKI `account` MICROSERVICE, DOBITI TAJ EVENT, JER LISTEN-UJE NA TAJ KANAL
...
**U SLEDECEM BRANCH-U CU VIDETI KAKO DA RESIM OVAJ PROBLEM**

ODMAH CU TI RECI DA JE RESENJE U STORINGU EVENTA U DATBASE
