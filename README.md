...
**STO ZNACI DA JE POKUSAN REQUEST PREMA LOCALHOST-U VIRUTUAL MACHINE U KOJOJ JE NAS NEXTJS SSR SERVER, DAKLE POKUSAN JE REQUEST PREMA `localhost:80/api/users/current-user` U VIRTUAL MACHINE-U SAMOG POD-A, U KOJEM RUNN-UJE NEXTJS SERVER**
